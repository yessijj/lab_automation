...
<center>
<div class="jumbotron">
<h1 style="font-family: 'Quantico', sans-serif; color: white;">Tests Name</h1>
</div>
...
$sql_fetch = "SELECT * from test_name_table";
...
while ($row=$result->fetch_array()) {
    ...
    $code = $row['Test_code'];
        ...
        <td><button class="btn btn-danger" name="btndel" type="submit" ><a href="test_name_delete.php?id=<?php echo $id ?>">Delete</a></button></td>
            <td><button class="btn btn-success" name="btnupd" type="submit" ><a href="test_name_update.php?id=<?php echo $id ?>">Update</a></button></td>
