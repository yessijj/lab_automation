...
<div id="div4">
  <h2 id="H1"><span style="color: black; margin-top: 200px; margin-left:10px; font-family: 'EB Garamond', serif;">PLEASE INSERT YOUR PRODUCT</span></h2></br>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <select name="productid" class="form-control" value="Select category" placeholder="add category ">
...
<select name="testname" class="form-control" value="Select category" placeholder="add category "> 
...
?>
  ...
  <input type="datetime-local" id="date" name="datetime"/>
     ...
     <div class="form-group">
      ...
      <input type="text" class="form-control"  placeholder="Enter product author" name="status"/>
    </div>

      <div class="form-group">
      <label for="pwd"> Type of product:</label>
<select name="type" class="form-control" value="Select category" placeholder="add category "> 
  <option>Select any one</option>
          <?php
...
<select name="tester" class="form-control" value="Select category" placeholder="add category ">
<option>Select any one</option> 
          <?php
...
<textarea placeholder="Please Enter your reviews" class="form-control" name="reviews"></textarea>   
 </div>



    <button type="submit" class="btn btn-info" name="btnsub">Send Product For Test</button></br></br>
        <button type="submit" class="btn btn-info" name="btn2">Send Product To Faulty Department</button>
...
$insert_data = "INSERT into testing_record_table(Testing_Id,Product_Id,Test_name,Date_col,Product_type,Prdouct_status,Tester_name,Reviews)values('$test_id','$Product_id','$test_name','$date','$protype','$pro_stat','$testers','$rev')";
...
$insert_data = "INSERT into faulty(Testing_Id,Product_Id,Test_name,Date_col,Product_type,Product_status,Tester_name,Reviews)values('$test_id','$Product_id','$test_name','$date','$protype','$pro_stat','$testers','$rev')";
