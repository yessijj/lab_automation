		...
		<div class="container">
			...
			<div class="formBox">
				<form method="post" action="">
						<div class="row">
							<div class="col-sm-12">
								<h1><span style="color:black;">ADD TESTER NAME</span></h1>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<input type="submit" name="btntester" class="button" value="ADD TESTER NAME">
							</div>
						</div>
...
$insert_tester = "INSERT into tester_table(Tester_Id,Tester_name) values('$testr_id','$testr_name')";
