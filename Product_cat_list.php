...
<center>
<div class="jumbotron">
<h1 style="font-family: 'Quantico', sans-serif; color: white;">Product Type</h1>
</div>
...
$sql_fetch = "SELECT * from product_type";
...
while ($row=$result->fetch_array()) {
    ...
    $name = $row['Prod'];
        ...
        <td><button class="btn btn-danger" name="btndel" type="submit" value=""><a href="Product_cat_delete.php?id=<?php echo $id ?>">Delete</a></button></td>
            <td><button class="btn btn-success" name="btnupd" type="submit" value=""><a href="Product_cat_update.php?id=<?php echo $id ?>">Update</a></button></td>
